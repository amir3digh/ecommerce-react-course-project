...
export default function ProductCard({ product }) {
  ...
  return (
    <div className="w-full relative flex pb-4 gap-2 flex-col items-center max-w-[300px] border-[3px] border-[#F6F7F8]">
      ...
      <div className="flex flex-col items-center gap-1 text-lg">
        <div className="font-bold text-[#223263] text-center">
          {product.title}
        </div>
      ...
      <button
        ...
        className="w-full justify-center items-center text-center text-white font-bold py-2 bg-[#FF4858]"
      >
        Add to Cart
      </button>
    </div>
